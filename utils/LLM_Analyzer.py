...
import time
from utils.tools import get_strict_json, get_strict_string
...
if __name__ == "__main__":
    ...
    dependChecker = DependecyChecker()
    for _ in range(10):
        result = dependChecker.check(comp['name'],comp['block_html'],context='I love ya')
        print(result)