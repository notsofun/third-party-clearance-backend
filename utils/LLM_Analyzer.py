...
class RelevanceChecker(AzureOpenAIChatClient):
    def __init__(self, endpoint="https://openai-aiattack-msa-001905-eastus-bsce-ai-00.openai.azure.com", deployment=None, embedding_deployment=None, api_version="2025-01-01-preview", client_id=None, client_secret=None, tenant_id=None, session_id='default', promptName='automation/Relevance'):
        super().__init__(endpoint, deployment, embedding_deployment, api_version, client_id, client_secret, tenant_id, session_id, promptName)
        self.promptName = promptName

    def check(self,component_name:str,file_name:str) -> str:
        """
